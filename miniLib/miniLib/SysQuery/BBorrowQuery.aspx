<%@ Page Title="" Language="C#" MasterPageFile="~/Front.Master" AutoEventWireup="true" CodeBehind="BBorrowQuery.aspx.cs" Inherits="miniLib.SysQuery.BBorrowQuery" %>
            ...
            <tr>
              <td colspan="3" valign="top" background="../images/tu shu pai hang2.gif" style="height: 246px">                
                ...
                ID="txtTTime" runat="server" Visible="False" Width="101px"></asp:TextBox></td>
                          <td width="165" class="daohang1" style="width: 156px"><asp:Label ID="Label3" runat="server" Text="（日期格式为：2007-01-01）" Visible="False"></asp:Label></td>
                          <td width="53" style="width: 47px"><label>
                            <asp:Button ID="btnQuery" runat="server" OnClick="btnQuery_Click" Text="查询" Height="26px" Width="56px" />
                          </label></td>
                        </tr>
                      </table></td>
                      </tr>
                ...
                <asp:GridView ID="gvBorrowInfo" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" Font-Size="9pt" OnPageIndexChanging="gvBorrowInfo_PageIndexChanging" Width="678px" HorizontalAlign="Center">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="UserId" HeaderText="读者编号" />
